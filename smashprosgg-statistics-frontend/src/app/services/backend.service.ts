...
export class BackendService {
  ...
  get_games(username: string) {
    console.log(environment.backend_url + "/get_all_games/user?username=" + username);
    return this.http.get<any>(environment.backend_url + "/get_all_games/user?username=" + username);
  }
}
